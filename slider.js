...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/nouislider.js":[function(require,module,exports) {
var define;
...
},{}],"js/wNumb.js":[function(require,module,exports) {
var define;
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var amountSlider = document.querySelector('.js-slider-amount');
var timeSlider = document.querySelector('.js-slider-time');
var interestSlider = document.querySelector('.js-slider-interest');

var setupSliders = function setupSliders() {
  if (amountSlider) {
    _nouislider.default.create(amountSlider, {
      start: [8500],
      step: 1,
      connect: 'lower',
      range: {
  ...
  if (timeSlider) {
    _nouislider.default.create(timeSlider, {
      start: [30],
      step: 1,
      connect: 'lower',
      range: {
  ...
  if (interestSlider) {
    _nouislider.default.create(interestSlider, {
      start: [20],
      step: 5,
      connect: 'lower',
      range: {
...
var setupListeners = function setupListeners() {
  ...
  interestSlider.noUiSlider.on('change', function () {
    updateRepayments();
  });
};

var updateRepayments = function updateRepayments() {
  var amountValue = parseInt(amountSlider.noUiSlider.get());
  var timeValue = parseInt(timeSlider.noUiSlider.get());
  var interestValue = parseInt(interestSlider.noUiSlider.get());
  var repaymentMonthly = (amountValue + amountValue / 100 * interestValue + 10 * timeValue) / timeValue;
  var repaymentTotal = amountValue + amountValue / 100 * interestValue + 10 * timeValue;
...
init();
},{"./nouislider":"js/nouislider.js","./wNumb":"js/wNumb.js"}]},{},["js/slider.js"], null)
